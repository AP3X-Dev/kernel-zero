...
const messages: Readonly<Record<FindingMessageCode, string>> & EvidenceMessages = Object.freeze({
  ...
  INGRESS_ESCAPE: "Unparsed ingress input reaches a call, return, or binding outside the allowed set.",
  INGRESS_PARSE_MISSING: "An ingress function never passes its input through a required parser.",
  INGRESS_PROOF_FAILED: "Ingress input flow could not be proven within the function.",
