...
const groups: readonly RequirementGroup[] = [
  ...
  { count: 8, evidence: "policy contract, persistence, service, governed-action, diff, UI read-model, and self-policy tests", prefix: "FR-POL", qualification: "local unit/static proof; isolated PostgreSQL workflow proof pending" },
  { count: 11, evidence: "validator CLI, discovery, engine, runner, public artifact, self-policy, and benchmark checks", prefix: "FR-VAL", qualification: "local executable proof" },
